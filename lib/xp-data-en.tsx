...
export const experiencesEn: Experience[] = [
  {
    ...
    achievements: [
      [
        ...
        {
          highlight: "react, node, redux and materialui",
        },
      ],
      [
        "build features ",
        {
          highlight: "from backend to frontend",
        },
  ...
  },
  {
    ...
    achievements: [
      [
        "ensure ",
        {
          highlight: "technical management, updating and animation",
        },
      ...
      [
        "write and send the ",
        { highlight: "monthly newsletter" },
        " and create ",
        { highlight: "emailing campaigns" },
  ...
  },
  {
    ...
    achievements: [
      [
        "plan and execute ",
        {
          highlight: "scientific communication projects and events",
        },
      ...
      [
        ...
        {
          highlight: "web and print communication materials",
        },
