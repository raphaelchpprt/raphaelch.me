...
export function ExperienceItem({ 
  ...
  return (
    <div className="flex flex-col gap-4 last:mb-0 mb-8">
      ...
      >
      {isExpanded ? showLessLabel : showMoreLabel}{isExpanded ? <ChevronUp className="inline" size={16}  /> : <ChevronDown className="inline"  size={16} />}
      </button>
    </div>
  );
};
